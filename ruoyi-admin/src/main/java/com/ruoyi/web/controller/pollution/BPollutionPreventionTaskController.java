...
public class BPollutionPreventionTaskController extends BaseController
{
    ...
    public TableDataInfo daiBanList(BPollutionPreventionTask bPollutionPreventionTask)
    {
        startPage();
        List<BPollutionPreventionTask> list = bPollutionPreventionTaskService.selectBPollutionPreventionTaskListByDeptId(bPollutionPreventionTask);
        return getDataTable(list);
    }
