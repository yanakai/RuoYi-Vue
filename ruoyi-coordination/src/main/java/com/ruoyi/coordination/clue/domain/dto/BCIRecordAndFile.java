...
public class BCIRecordAndFile extends BClueInfoRecord {
    ...
    //审核时间
    private Date exTime;
    private List<BClueInfoRecordFile> fileList;
    ...
    public List<BClueInfoRecordFile> getFileList() {
        return fileList;
    }

    public void setFileList(List<BClueInfoRecordFile> fileList) {
