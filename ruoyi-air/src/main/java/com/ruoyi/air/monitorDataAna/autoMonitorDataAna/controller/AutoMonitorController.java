...
public class AutoMonitorController {
    ...
    static {
        ...
        params.put("districtCodes","3ce09c117a5b4cf7a8eb91eac12aa9d9");
    ...
    public AjaxResult getOrder(HttpServletRequest request, HttpServletResponse response,Map<String, Object> params) {

        return autoMonitorService.getOrder(params);
    }
