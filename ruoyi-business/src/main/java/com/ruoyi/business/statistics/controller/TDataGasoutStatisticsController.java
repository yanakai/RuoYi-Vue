...
public class TDataGasoutStatisticsController extends BaseController {
    ...
    public void monthExport(HttpServletResponse response, TDataGasoutStatisticsDTO tDataGasoutStatisticsDTO) {
        List<TDataGasoutMonthStatistics> list = tDataGasoutDayStatisticsService.selectTDataGasoutMonthStatisticsList(tDataGasoutStatisticsDTO);
        ExcelUtil<TDataGasoutMonthStatistics> util = new ExcelUtil<TDataGasoutMonthStatistics>(TDataGasoutMonthStatistics.class);
    ...
    public void yearExport(HttpServletResponse response, TDataGasoutStatisticsDTO tDataGasoutStatisticsDTO) {
        List<TDataGasoutYearStatistics> list = tDataGasoutDayStatisticsService.selectTDataGasoutYearStatisticsList(tDataGasoutStatisticsDTO);
        ExcelUtil<TDataGasoutYearStatistics> util = new ExcelUtil<TDataGasoutYearStatistics>(TDataGasoutYearStatistics.class);
